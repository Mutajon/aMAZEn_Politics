                        ...
                        <div className="flex gap-2">
                            {(['easy', 'normal', 'hard'] as const).map((level) => {
                                ...
                                return (
                                    ...
                                    >
                                        {lang(`LOBBY_DIFFICULTY_${level.toUpperCase()}` as any)}
                                    </button>
                                );
                            })}
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-8 px-4">
                            ...
                            >
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <span className="text-[10px] font-black uppercase tracking-widest text-white text-center px-4 shadow-black drop-shadow-md">{lang("LOBBY_POLITICAL_DRAMA")}</span>
                                </div>
                            ...
                            >
                                ...
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <span className="text-[10px] font-black uppercase tracking-widest text-white text-center px-4 shadow-black drop-shadow-md">{lang("LOBBY_POLITICAL_COMEDY")}</span>
                                </div>
                        ...
                        <div className="flex items-center justify-between gap-4">
                            ...
                            <div className={`flex-1 space-y-3 transition-opacity duration-300 ${isEmphasisDisabled ? 'opacity-20 pointer-events-none' : 'opacity-100'}`}>
                                ...
                                <textarea
                                    ...
                                    placeholder={lang("LOBBY_PLACEHOLDER_EMPHASIS_LONG")}
