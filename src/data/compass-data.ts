...
export const PROPERTIES = [
  ...
  export const COMPONENTS: Record<PropKey, { short: string; full: string }[]> = {
    ...
    how: [
      ...
      { short: "Design", full: "Shaping systems and interfaces to make good outcomes easier." },
...
export const COMPONENT_CUES: Record<PropKey, { short: string; example: string }[]> = {
  ...
  how: [
    ...
    { short: "Design", example: "Shape systems and interfaces to enable desired outcomes." },
