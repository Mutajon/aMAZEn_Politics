...
export async function freePlayTurn(req, res) {
    try {
        ...
        // --------------------------------------------------------
        if (day === 1) {
            console.log(`[FREE-PLAY] Day 1: Starting new game for ${playerName} (${role}, gender: ${gender}, tone: ${tone}, model: ${modelOverride || 'default'})`);
            ...
            const meta = {
                ...
                aiModel: modelOverride || "gemini-3-flash-preview", // Preserved model for persistence
        ...
        if (day > 1) {
            ...
            console.log(`[FREE-PLAY] 🤖 Active Model: ${conversation.meta.aiModel || "gemini-3-flash-preview"}`);
